...
- **🎯 docs/planning_v3//$ARGUMENTS/phase3-step2-implementation-design.md** # 実装設計 ← **現在のステップ**
...
承認された内容を @docs/planning_v3//$ARGUMENTS/phase3-step2-implementation-design.md に出力してください
